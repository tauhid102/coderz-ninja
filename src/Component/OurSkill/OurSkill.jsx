          ...
          <Slider {...settings}>
            <div>
              <div className="row row-cols-2 row-cols-md-3 row-cols-lg-5 g-4 mt-4 text-center">
                <div className="col">
                  <img width='60%' className="iconBackground" src={icon1} alt="html" />
                </div>
                <div className="col">
                  <img width='60%' className="iconBackground" src={icon2} alt="html" />
                </div>
                <div className="col">
                  <img width='60%' className="iconBackground" src={icon3} alt="html" />
                </div>
                <div className="col">
                  <img width='60%' className="iconBackground" src={icon4} alt="html" />
                </div>
                <div className="col">
                  <img width='60%' className="iconBackground" src={icon5} alt="html" />
                </div>
                <div className="col displayNone">
                </div>
                <div className="col">
                  <img width='60%' className="iconBackground" src={icon6} alt="html" />
                </div>
                <div className="col">
                  <img width='60%' className="iconBackground" src={icon7} alt="html" />
                </div>
                <div className="col">
                  <img width='60%' className="iconBackground" src={icon8} alt="html" />
                </div>
              </div>
            </div>
            <div>
